...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.operation_type_switch = ctk.CTkSwitch(self.center_frame,
                                              ...
                                              switch_height=50,
                                              text="",
                                              fg_color=ThemeConstants.translation_direction_switch_theme_color["off"],
                                              progress_color=ThemeConstants.translation_direction_switch_theme_color["on"],
                                              button_color=ThemeConstants.translation_direction_switch_theme_color["btn"],
                                              button_hover_color=ThemeConstants.translation_direction_switch_theme_color["btnh"])
        ...
        self.mode_selector_label = ctk.CTkLabel(self.bottom_frame, text="Mode:", font=ThemeConstants.other_font)
        self.mode_selector_label.grid(row=0, column=0, padx=(20, 0), sticky="sw")

        self.translation_mode_var = ctk.StringVar(value=ThemeConstants.translation_mode_values[0])
        self.mode_selection_menu = ctk.CTkOptionMenu(self.bottom_frame,
                                                      values=ThemeConstants.translation_mode_values,
        ...
        self.api_switch = ctk.CTkSwitch(self.bottom_frame,
                                              offvalue=ThemeConstants.api_states[1],
                                              onvalue=ThemeConstants.api_states[0],
                                              variable=self.api_switcher_var,
                                              switch_width=70,
                                              switch_height=40,
                                              text="",
                                              command=self.change_api_state,
                                              fg_color=ThemeConstants.api_state_switch_theme_color["off"],
                                              progress_color=ThemeConstants.api_state_switch_theme_color["on"],
                                              button_color=ThemeConstants.api_state_switch_theme_color["btn"],
                                              button_hover_color=ThemeConstants.api_state_switch_theme_color["btnh"])
        self.api_switch.grid(row=1, column=1)

        self.theme_selector_label = ctk.CTkLabel(self.bottom_frame, text=":Theme", font=ThemeConstants.other_font)
    ...
    def transate_button(self):
        ...
        if not input_text or input_text == f"Enter your text here...{chr(0x200B)}":
            result = ""
        elif self.translation_mode_var.get() == ThemeConstants.translation_mode_values[0]:
    ...
    def change_theme(self, choice):
        ...
        if str(ctk.get_appearance_mode()).lower() == ThemeConstants.theme_values[2].lower():
    ...
    def change_api_state(self):
        import threading
        if self.api_switcher_var.get() == ThemeConstants.api_states[0]:
    ...
    def start_api(self):
        ...
        try:
            ...
            self.api_switcher_var = ThemeConstants.api_states[1]
